                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-12 mx-auto">
                            ...
                            <form action="index.php" method="post" class="contact-form" role="form" data-aos="fade-up">
                                ...
                                <div class="col-lg-5 col-12 mx-auto mt-5">
                                    <button type="submit" class="form-control" name="submitmessage">Send Message</button>
                                </div>
                            </form>
                        </div>
